This repository contains the Web.config files from Sitecore versions starting with 8.2, allowing an easy method of comparison when performing upgrades that involve customised Web.config files.
